...
% \renewcommand{\myinstlogo}{./corvinus-logos/black_finance_ENG.pdf}
% \renewcommand{\myinstlogo}{./corvinus-logos/black_finance_HUN.pdf}
% \renewcommand{\myinstlogo}{./corvinus-logos/black_simple_ENG.pdf}
% \renewcommand{\myinstlogo}{./corvinus-logos/black_simple_HUN.pdf}

\title{Corvinus Metropolis Template}
\subtitle{Examples and usage}
\author{John Doe}
\email{john.doe@uni-corvinus.hu}
...
\institute[Corvinus University]
  ...
  Email: \putemail\\
  Download from:
  \url{https://github.com/m-marcell/corvinusmetropolis-updated}
  }
\date{\today}
...
\frame{
    \frametitle{Definition of quadratic forms}
