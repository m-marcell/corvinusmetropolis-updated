...
\renewcommand{\myinstlogo}{./corvinus-logos/black_math_ENG.pdf}

\title{Quadratic Forms}
\subtitle{Example with professor Magyarkuti's quadratic forms lecture}
\author[Magyarkuti]{Original author: Gyula Magyarkuti\,\orcidlink{0000-0003-4444-0481}}%The name only, if the author does not prefer orcidlink.
...
\institute[Corvinus University]
  ...
  Email: \putemail\\
  Original version: 
  \url{https://github.com/magyarkuti/corvinusmetropolis}
  }
\date{Compiled on: \today}
\titlegraphic{\hfill{\includegraphics[width=.25\textwidth]{\myinstlogo}}}
